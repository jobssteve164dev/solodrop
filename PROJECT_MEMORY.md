...
- Preview content is independent of the managed component. Optional CTA, attribution and statistics cannot become prerequisites for reading or downloading an artifact.
...
- `worker/src/index.mjs` owns short-link validation, lifecycle, CTA configuration, visit counts, rate limits and management-token deletion. It does not proxy or store artifact contents.
