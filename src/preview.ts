...
export async function buildPreview(artifact: ArtifactSelection, outputDirectory: string): Promise<void> {
  ...
  if (extension === '.html' || extension === '.htm') {
    ...
    body = `<div class="office-viewer" data-office-format="${extension.slice(1)}" data-office-src="./${encodeURIComponent(targetName)}"></div><script type="module" src="https://drop.szlk.ai/office-viewer.js?v=1"></script>`;
