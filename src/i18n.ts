...
export interface Strings {
  ...
  localOnly: string; temporaryLimit: string; notConnected: string;
}
...
const translations: Record<SupportedLocale, Strings> = {
  en: {
    ...
    sharePreview: 'Share preview', chooseFile: 'Choose a file', linkCopied: 'Link copied', open: 'Open', copyAgain: 'Copy again', keepPreview: 'Keep this preview', recent: 'Recent', refresh: 'Refresh', emptyHistory: 'Shared previews will appear here.',
  ...
  'zh-cn': {
    ...
    sharePreview: '分享预览', chooseFile: '选择文件', linkCopied: '链接已复制', open: '打开', copyAgain: '再次复制', keepPreview: '保留这个预览', recent: '最近分享', refresh: '刷新', emptyHistory: '分享过的预览会显示在这里。',
