...
> SoloDrop share links are public to anyone who has the URL. Watermarks and hidden downloads guide normal recipient behavior; they are not DRM.<br />
> SoloDrop 分享链接对拿到网址的人公开。水印与隐藏下载用于约束常规接收行为，不等同于 DRM。
